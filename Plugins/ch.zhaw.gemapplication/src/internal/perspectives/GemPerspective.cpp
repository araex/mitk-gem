...
void GemPerspective::CreateInitialLayout(berry::IPageLayout::Pointer _layout)
{
    ...
    _layout->AddView("org.mitk.views.datamanager", berry::IPageLayout::LEFT, 0.18f, editorArea);
    ...
    auto rightFolder = _layout->CreateFolder("right", berry::IPageLayout::RIGHT, 0.65f, editorArea);
    ...
    auto bottomRightFolder = _layout->CreateFolder("bottomright", berry::IPageLayout::BOTTOM, 0.7587f, "right");
    ...
    auto bottomFolder = _layout->CreatePlaceholderFolder("bottom", berry::IPageLayout::BOTTOM, 0.763f, editorArea);
