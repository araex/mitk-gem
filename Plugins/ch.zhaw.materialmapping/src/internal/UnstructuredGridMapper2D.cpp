...
void mitk::UnstructuredGridPointMapper2D::GenerateDataForRenderer( mitk::BaseRenderer* renderer )
{
...
void mitk::UnstructuredGridPointMapper2D::Paint( mitk::BaseRenderer* renderer )
{
    bool visible = true;
...
vtkAbstractMapper3D*
mitk::UnstructuredGridPointMapper2D
...
vtkScalarsToColors* mitk::UnstructuredGridPointMapper2D::GetVtkLUT(mitk::BaseRenderer* renderer)
{
    //MITK_INFO << "GETVTKLUT\n";
...
bool mitk::UnstructuredGridPointMapper2D::IsConvertibleToVtkPointSet(mitk::BaseRenderer * renderer)
{
    return ( GetVtkPointSet(renderer,this->GetTimestep()) != 0);
}

mitk::UnstructuredGridPointMapper2D::UnstructuredGridPointMapper2D()
{
