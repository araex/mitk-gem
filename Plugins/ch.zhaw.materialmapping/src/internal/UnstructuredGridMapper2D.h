 ...
 */
    class MITKMAPPEREXT_EXPORT UnstructuredGridPointMapper2D : public GLMapper
{
    public:

    mitkClassMacro( UnstructuredGridPointMapper2D, GLMapper );
    ...
    UnstructuredGridPointMapper2D();

    virtual ~UnstructuredGridPointMapper2D();
